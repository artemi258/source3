...
/* harmony import */ var _modules_slider_MainSliders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/slider/MainSliders */ "./src/js/modules/slider/MainSliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_MainSliders__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  var sliderModulew = new _modules_slider_MainSliders__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.sidecontrol__controls .next',
    prevModules: '.prevmodule',
    nextModules: '.nextmodule'
  });
  sliderModulew.render();
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]().init();
  ...
  new _modules_accordeon__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info .plus', '.module__info .msg').init();
...
/*#__PURE__*/
function () {
  function Accordeon(button, content) {
  ...
  _createClass(Accordeon, [{
    ...
    value: function hideContent() {
      ...
      this.button.forEach(function (btn, i) {
        btn.addEventListener('click', function () {
          _this.content.forEach(function (item) {
            item.classList.remove('fadeInBottomAccordBack');
          });

          if (_this.content[i].classList.contains('fadeInBottomAccord')) {
            _this.content[i].classList.remove('fadeInBottomAccord');

            _this.content[i].classList.add('fadeInBottomAccordBack');

            setTimeout(function () {
              _this.content[i].style.display = 'none';
            }, 300);
          } else if (!_this.content[i].classList.contains('fadeInBottomAccord')) {
            _this.content[i].classList.add('fadeInBottomAccord');

            _this.content[i].style.display = 'flex';
          }
        });
      });
    }
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTrigger",
    value: function bindTrigger(officer, officerCount, officerItems) {
    ...
    key: "hideItems",
    value: function hideItems(officerItems) {
      officerItems.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
          item.style.display = 'none';
        }
      });
    ...
    value: function sortingForm() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          _this.postData('./assets/question.php', formData).then(function (item) {
            console.log(item);
          });
        });
      });
...
/*#__PURE__*/
function () {
  function VideoPlay(trigger, overlay) {
...
/***/ "./src/js/modules/slider/MainSliders.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slider/MainSliders.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MainSliders; });
...
/* harmony import */ var _Slides__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Slides */ "./src/js/modules/slider/Slides.js");
...
/*#__PURE__*/
function (_Slides) {
  _inherits(MainSliders, _Slides);

  function MainSliders(slides) {
    _classCallCheck(this, MainSliders);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSliders).call(this, slides));
  }
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            ...
            _this.hanson.classList.add('fadeInBottom');
          }, 3000);
        } else {
  ...
  return MainSliders;
}(_Slides__WEBPACK_IMPORTED_MODULE_9__["default"]);



/***/ }),

/***/ "./src/js/modules/slider/Slides.js":
/*!*****************************************!*\
  !*** ./src/js/modules/slider/Slides.js ***!
  \*****************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_Slides) {
  _inherits(SliderMini, _Slides);

  function SliderMini(container, next, prev, active, animate, auto) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, next, prev, active, animate, auto));
  }
  ...
  _createClass(SliderMini, [{
    ...
    value: function bindSlider() {
      ...
      this.next.addEventListener('click', function () {
        ...
        for (var i = _this.slides.length - 1; i > 0; --i) {
          if (_this.slides[i].closest('button')) {
            _this.container.insertBefore(_this.slides[i], _this.slides[_this.slides.length - 2]);
          }
    ...
    key: "bindActive",
    value: function bindActive() {
      var _this3 = this;

      this.slides.forEach(function (item) {
        item.classList.remove(_this3.active);
