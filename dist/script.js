...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init(); // new Difference('.officerold', '.officernew', '.officer__card-item').init();

  var diff = new _modules_difference__WEBPACK_IMPORTED_MODULE_2__["default"]('.officerold', '.officernew', '.officer__card-item');
  diff.init();
...
function (_Slides) {
  ...
  function MainSliders(slide) {
    _classCallCheck(this, MainSliders);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSliders).call(this, slide));
  }
